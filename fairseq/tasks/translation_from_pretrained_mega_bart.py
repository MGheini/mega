...
class TranslationFromPretrainedMEGABARTTask(TranslationTask):
    """
    ...
    def add_args(parser):
        ...
        parser.add_argument('--prepend-bos', action='store_true',
                            help='prepend bos token to each sentence, which matches '
                                 'mBART pretraining')
        parser.add_argument('--unseen-lang', action='store_true',
                            help='whether the source or target language was not seen'
                                 'during pretraining.')
        # fmt: on
